...
router.get('/all', userMiddleware.isLoggedIn, (req, res) => {
...
// list of packages
router.get('/list-paket', (req, res) => {
  res.send(db.Paket.data);
});

// delete admin user
router.delete('/admin/:id', userMiddleware.isLoggedInCookie, (req, res) => {
...
// edit admin user
router.put('/admin/:id', userMiddleware.isLoggedInCookie, userMiddleware.repeatPassword, (req, res) => {
  if (!db.Admin.data.some((e) => e.id === req.params.id)) return res.status(400).send({ msg: 'User not found' });
...
// add new customer
router.post('/customer', userMiddleware.isLoggedInCookie, userMiddleware.subscriptionList, (req, res) => {
...
// delete customer
router.delete('/customer/:id', userMiddleware.isLoggedInCookie, (req, res) => {
...
// edit customer
router.put('/customer/:id', userMiddleware.isLoggedInCookie, userMiddleware.subscriptionList, (req, res) => {
